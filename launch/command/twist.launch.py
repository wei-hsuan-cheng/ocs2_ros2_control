...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("twistPublishRate", default_value="20.0", description="Twist target publish rate."),
        DeclareLaunchArgument("twistHorizon", default_value="1.0", description="Twist target horizon (s)."),
        DeclareLaunchArgument("twistDt", default_value="0.1", description="Twist discretization step (s)."),
        DeclareLaunchArgument("twistInWorld", default_value="true", description="Interpret twist in world frame."),
        DeclareLaunchArgument("twistVelX", default_value="0.0"),
        DeclareLaunchArgument("twistVelY", default_value="0.0"),
        DeclareLaunchArgument("twistVelZ", default_value="0.0"),
