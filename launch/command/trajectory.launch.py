...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("trajectoryPublishRate", default_value="20.0", description="Trajectory target publish rate."),
        DeclareLaunchArgument("trajectoryHorizon", default_value="2.0", description="Trajectory horizon (s)."),
        DeclareLaunchArgument("trajectoryDt", default_value="0.05", description="Trajectory discretization step (s)."),
        DeclareLaunchArgument("trajectoryAmplitude", default_value="0.2", description="Eight-shape amplitude (m)."),
        DeclareLaunchArgument("trajectoryFrequency", default_value="0.1", description="Eight-shape frequency (Hz)."),
        DeclareLaunchArgument("trajectoryAxisX", default_value="0.0"),
